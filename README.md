...
This tree ships **six packs**, **seven engines**, and **thirty-eight shipped requirements**. The machine-readable source and every destination are listed in [`docs/README.md`](docs/README.md).
...
- **Packs and adoption:** six packs cover 38 duties, including the immutable Seoul Frontier AI Safety Commitments edition; use the GitHub Action, Docker image, `init pack|engine` scaffolds, JSON schema, and [registry](docs/registry.html) as the adoption surface.
