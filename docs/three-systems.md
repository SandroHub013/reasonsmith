...
> **Produced with reasonsmith `0.8.0` — the version of the tree these blocks were generated
...
> that your install is broken; upgrade to `0.8.0` or newer and re-run before comparing.
